...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?= base_url() ?>assets/AdminLte-2.3.0/plugins/iCheck/square/blue.css">
  ...
  <body class="hold-transition login-page">
    ...
    <!-- jQuery 2.1.4 -->
    <script src="<?= base_url() ?>assets/AdminLte-2.3.0/plugins/jQuery/jQuery-2.1.4.min.js"></script>
    <!-- Bootstrap 3.3.5 -->
